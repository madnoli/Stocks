...
# --- CONTROL FLAGS ---
# =========================
BUYER_MODE = True           # Apply option-buyer gates [attached_file:1]
RELAXED_MODE = True         # Relax sector-delta/ATR/ADX thresholds until history builds [attached_file:1]
...
class Enhanced3SectorScanner:
    ...
    def show_sector_status(self):
        ...
        print(f"{Colors.MAGENTA}Worst: {', '.join(self.worst_sectors)}{Colors.RESET}")  # [attached_file:1]
