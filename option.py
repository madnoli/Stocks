...
def main():
    ...
    #print(gainer)
    gainer = my_analytics.get_index_gainer_losers(top = 20 ,  segment = "EQ" ,index_name = "NIFTY 50" ,sort_by = "gainers")
    print(gainer)
    gainer = my_analytics.get_industry_gainer_losers(	top = 20 ,  segment = "EQ" , industry = "Information Technology" ,sort_by = "gainers")
    print(gainer)
    chain = my_analytics.get_option_chain(symbol = "VEDL" , expiry = d(2025 , 10 , 28) , greeks = True)
    print(chain)
