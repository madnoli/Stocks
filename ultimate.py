# ==============================================================================
# ULTIMATE OPTION BUYER SCANNER v5.0 - ENHANCED WITH ALL DATETIME FIXES
...
class Config:
    ...
    MIN_TOTAL_OI = 5000 # Minimum total OI for liquidity
    MIN_TOTAL_VOL = 500 # Minimum total volume
    ...
    IV_LOW_THRESHOLD = 25.0 # Volume surge multiplier
    ...
    GROUP_WEIGHTS = {
        ...
        "OptionChain": 4.0, # NEW - highest weight for option-specific signals
    }
    ...
    INDICATOR_WEIGHTS = {
        ...
        "PCR_Signal": 4.0,
        "PCVR_Signal": 3.5, # PCR analysis for option direction
        "OI_Change_Signal": 3.2, # OI percentage changes
        "Option_Volume_Surge": 3.5, # CE/PE volume analysis
        "ATM_Dominance": 3.0, # At-the-money activity
        "IV_Skew_Signal": 2.5, # Implied volatility skew
        "Liquidity_Score": 3.0,
        "Bid_Ask_Spread": 2.5,
        "Max_Pain_Distance": 2.0,
        "Volume_Profile": 2.2, # Option liquidity assessment
    }
...
class LocalhostOptionChainAPI:
    ...
    def calculate_liquidity_score(self, total_oi, total_vol, strikes_data):
        """v5.0 ENHANCED liquidity calculation"""
        try:
...
def calculate_option_chain_scores(option_chain_data):
    ...
    try:
        ...
        elif volume_surge_ratio >= Config.MIN_VOL_SURGE_THRESHOLD:
            scores['Volume_Profile'] = 1.0
        elif volume_surge_ratio < 0.7:
            scores['Volume_Profile'] = -1.0 # Strong put setup
...
MAJOR DATETIME FIXES:
  ...
  🔧 Fixed: Market hours checking with proper time.time() vs datetime.datetime() usage
