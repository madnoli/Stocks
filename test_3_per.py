# Enhanced Multi-Indicator Scanner with 3 Best/Worst Sectors & Gap-Down Filter
# Features: 3 best/worst sectors, top 10 bullish/bearish stocks, gap-down exclusion
import pandas as pd
import numpy as np
...
# --- ENHANCED LIVE SCANNER WITH 3 BEST/WORST SECTORS & GAP-DOWN FILTER ---
class Enhanced3SectorLiveScanner:
    def __init__(self):
        ...
        logger.info("🚀 Enhanced 3-Sector Live Scanner with Gap-Down Filter initialized")
    ...
    def show_initialization_status(self):
        ...
        print(f"\n{Colors.CYAN}{Colors.BOLD}🚀 ENHANCED 3-SECTOR SCANNER WITH GAP-DOWN FILTER{Colors.RESET}")
    ...
    def enhanced_3sector_scan_cycle(self):
        """Enhanced 3-sector scan with gap-down filtering"""
    ...
    def run_enhanced_3sector_scanner(self):
        """Main enhanced 3-sector scanner"""
...
# --- MAIN EXECUTION ---
def main():
    print(f"{Colors.CYAN}{Colors.BOLD}🎯 ENHANCED 3-SECTOR SCANNER WITH GAP-DOWN FILTER{Colors.RESET}")
    ...
    scanner = Enhanced3SectorLiveScanner()
    try:
        scanner.run_enhanced_3sector_scanner()
    except KeyboardInterrupt:
        print(f"\n{Colors.YELLOW}👋 Shutting down 3-sector scanner...{Colors.RESET}")
        scanner.stop()
