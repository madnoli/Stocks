...
class EnhancedOptionBuyerScanner:
    ...
    def calculate_option_buyer_signals(self, symbol, timeframes_data):
        """Enhanced signal calculation for option buyers using volume, OI, and option chain - CORRECTED VERSION"""
        try:
...
if __name__ == "__main__":
    ...
    print(f"{Colors.CYAN}Version 2.1 - October 2025 - CORRECTED{Colors.RESET}")
