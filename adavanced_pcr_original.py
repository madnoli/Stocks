...
SECTOR_STOCKS = {
    ...
    "Metal": ["TATASTEEL-I", "JSWSTEEL-I", "SAIL-I", "JINDALSTEL-I", "HINDALCO-I", "NMDC-I", "VEDL-I"],
    ...
    "Finance": ["BAJFINANCE-I", "SHRIRAMFIN-I", "CHOLAFIN-I", "HDFCLIFE-I", "ICICIPRULI-I"],
...
class EnhancedOptionBuyerScanner:
    ...
    def calculate_option_buyer_signals(self, symbol, timeframes_data):
        ...
        try:
            ...
            # =========================
            # --- ACTUAL OPTION CHAIN INTEGRATION (NOW PROPERLY IMPLEMENTED) ---
            # =========================
            ...
            if chain_scores:
                ...
                if oc_weight_sum > 0:
                    ...
                    logger.info(f"Option chain integrated for {symbol}: Technical={original_score:.1f}, Options={oc_score:.1f}, Final={base_score:.1f}")
    ...
    def enhanced_scan_cycle(self):
        ...
        print("Analyzing: 5min 15min 30min 60min Daily with Volume & Open Interest + OPTION CHAIN")
        print(f"Focus: {Colors.GREEN}Volume-OI Flow{Colors.RESET}, {Colors.BLUE}Institutional Activity{Colors.RESET}, {Colors.MAGENTA}Option Chain Integration{Colors.RESET}")
        ...
        print(f"Enhanced option buyer scanning {len(target_stocks)} stocks with Volume+OI analysis + OPTION CHAIN")
        live_signals = []
        gapdown_filtered = 0
    ...
    def display_option_buyer_signals(self, signals, scan_time, gapdown_filtered, current_time):
        ...
        console.print(f"[blue]🎯 Enhanced for Option Buyers: Volume-OI Flow + Institutional Activity + Options Momentum + Option Chain Integration[/]")
...
def interactive_mode():
    ...
    while True:
        ...
        print("7. Quick symbol test")
        print("8. Benchmark option chain speed")
        print("0. Exit")
